...
public class ResidentTest {
	...
	public void testGetFilteredResidentLists() {
				...
				expect(repository.getResidents("1")).andReturn(test);
				...
				Resident filter2 = new Resident("Tom", "", "", "", date1 );
				List<Resident> filtered2 = new ArrayList<Resident>();
				filtered2.add(r3);
						
				
				assertThat(service.getFilteredResidentsList(filter), equalTo(filtered));
				
				assertThat(service.getFilteredResidentsList(filter2), equalTo(filtered2));
